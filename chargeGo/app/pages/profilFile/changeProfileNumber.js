  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <AntDesign name="arrowleft" size={20} color={colors.color_black} />
        </TouchableOpacity>
        <TouchableOpacity>
          <Text style={[styles.whiteModalCenter_text, { fontSize: 13 }]}>
            {t("İşlemi İptal Et")}
          </Text>
        </TouchableOpacity>
      </View>
      ...
      <ModalGenerate
        ...
        modalHeader={t("Numaranız Değiştirilmiştir")}
        modalDetail="*** ** ** 65 . sonu 65 ile biten numaranız 0533 237 45 46  numara ile değiştirilmiştir. "
        modalType="success"
        buttonText={t("Tamam")}
        click={() => navigation.navigate("pages/profilFile/profilAccount")}
      />
    </View>
  );
};

export default ChangeProfileNumber;
